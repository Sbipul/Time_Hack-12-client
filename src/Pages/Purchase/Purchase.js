            ...
            <NavBar/>
                <div className="row">
                    ...
                    <Card className="bg-dark text-white">
                        <Card.Img id="overlayImg" style={{height:'90vh'}} className="w-100" src={singleItem?.img} alt="Card image" />
                        <Card.ImgOverlay>
                            <Container>
                            <div className="row mt-5">
                                <div className="col-12 col-md-4">
                                    <div className="p-5" style={{background:'rgba(0, 0, 0, 0.363)'}}>
                                ...
                                <div className="col-12 col-md-8">
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <input className="w-100" type="text" value={qua} placeholder="Qauntity" {...register("quantity", { required: true })} /><br/><br/>
